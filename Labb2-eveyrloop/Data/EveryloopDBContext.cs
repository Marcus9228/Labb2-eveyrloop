...
namespace Labb2_eveyrloop.Data;

public partial class EveryloopDBContext : DbContext
{
    public EveryloopDBContext()
    {
    }

    public EveryloopDBContext(DbContextOptions<EveryloopDBContext> options)
        : base(options)
    {
    }
